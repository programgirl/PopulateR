...
#' @param meanUsed The mean for the distribution of mother ages at childbirth.
#'  @param sdUsed The standard deviation of the  distribution of mother ages at childbirth.
