...
#' #' This function creates a matching household identifier for the parent and child. If the parent has a household identifier, use the childbetayes function instead.
#'
#' @export
...
childno <- function(children, chlidcol, chlagecol, parents, paridcol, paragecol, a, b, location, scale, 
