...
#' @param chlid The ID variable in the children data frame.
...
#' @param twinrate The proportion of births that are twins rather than singletons.
...
#' @param parid The ID variable in the parents data frame.
...
#' @param HouseholdNumVariable The name of the household variable in the parents data frame.
...
#'                      twinrate = .2, Parents, parid = 3, parage = 4,
#'                      minparage = 18, maxparage = 54, hhidcol = 6,
#'                      userseed = 4)



pairchildNum <- function(children, chlid, chlage, numchild = 2, twinrate = 0, parents, parid, parage, minparage = NULL,
                       maxparage = NULL, HouseholdNumVariable = NULL, userseed=NULL, maxdiff=1000)

{
  ...
  ExpctNumHHTwins <- round(nrow(childrenRenamed)*twinrate)
