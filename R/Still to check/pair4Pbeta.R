...
pair4Pbeta <- function(smalldf, smlid, smlage, largedf, lrgid, lrgage, shapeA=NULL, shapeB=NULL, locationP=NULL, 
                       scaleP = NULL, IDStartValue, HouseholdNumVariable, userseed=NULL, attempts=10) {
