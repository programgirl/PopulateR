...
#'                      userseed = 4)
pairchild <- function(children, chlid, chlage, numchild = 2, twinrate = 0, parents, parid, parage,
                      minparage = NULL, maxparage = NULL, IDStartValue = NULL, HouseholdNumVariable= NULL, 
  ...
  
{
  ...
  # ExpctNumHH <- round(nrow(childrenRenamed)*twinrate) - round(nrow(childrenRenamed)*twinrate) %% 2
  ExpctNumHH <- round(nrow(childrenRenamed)*twinrate)
