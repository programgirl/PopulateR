...
#' @param exsid The column number for the ID variable, for people in the existing data frame.
#' @param exsage The column number for the Age variable, for people in the existing data frame.
...
#' @param addid The column number for the ID variable, for people to be added to the existing households.
#' @param addage The column number for the Age variable, for people in the existing data frame.
